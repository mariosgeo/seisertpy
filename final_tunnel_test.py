...
# 2. ενδιάμεσος χώρος-κέλυφος γύρω από το τούνελ (max area 0.8)
# Μειώθηκε από 1.5 σε 0.8 για λεπτότερο πλέγμα στην ζώνη υψηλής ευαισθησίας
# γύρω από το τούνελ και την κορυφή της ανωμαλίας.
plc_2d.addRegionMarker([0, 3.75], marker=2, area=0.8)
