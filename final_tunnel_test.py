...
mesh_2d = mt.createMesh(plc_2d, quality=34.0)#δεν προσθέτουμε το area=1.0 όπως στους προηγούμενους κώδικες οπότε το κάθε marker που ορίσαμε πριν
...
mesh_3d.exportVTK(r"/export/home/mnotia/final_tunnel.vtk")
print("All done! Results saved to final_tunnel.vtk")

# ==========================================
# 4. FORWARD MODEL
# ==========================================
print("\n3. Generating Gradient array protocol...")
scheme = ert.createData(elecs=sensors_3d, schemeName='gr')

rhomap = {1: 1000.0, 2: 1000.0, 3: 10.0}
res = np.array([rhomap.get(cell.marker(), 1000.0) for cell in mesh_3d.cells()])
...
inv_mesh.exportVTK(r"/export/home/mnotia/final_inverted_tunnel.vtk")
print("All done!")